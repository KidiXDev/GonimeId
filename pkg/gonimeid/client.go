// Package gonimeid provides a public API for anime scraping and searching functionality.
...
// NewClient creates a new GonimeId client backed by the Model B registry.

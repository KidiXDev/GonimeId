# GonimeId Library - Usage Examples
...
func main() {
    ...
    if len(episodes) > 0 {
        ...
        streamURL, metadata, err := client.GetEpisodeStreamURL(selectedAnime, episodes[0], &gonimeid.StreamOptions{
            Quality: "best",
            Mode:    "sub",
        })
        if err != nil {
...
#### `NewClient() *Client`
Creates a new GonimeId client with all available scrapers initialized.
